...
const History: React.FC = () => {
  return (
    <div className="w-[90%] mx-auto my-8 bg-poise bg-cover bg-no-repeat bg-[rgba(5,255,255,0.9)]">
      <div className="w-full p-10 bg-[rgba(23,14,14,0.7)]">
        <h4 className="font-bold text-lg my-2 text-center text-white">
          POISE.NG
        </h4>
        <div className="flex gap-2 justify-center font-semibold text-orange-400 mb-3">
          <span>Charisma.</span>
          <span>Class.</span>
          <span>Comfort.</span>
        </div>
        <div className="text-start">
          <div className="lg:basis-[20%] mb-4">
            <h5 className="font-bold text-orange-400 mb-2">Vision</h5>
          ...
          <div className="lg:basis-[20%] mb-4">
            <h5 className="font-bold text-orange-400 mb-2">Why Us?</h5>
            <p className="leading-5 text-white">
          ...
          <div className="lg:basis-[20%] mb-4">
            <h5 className="font-bold text-orange-400 mb-2">100% Quality</h5>
            <p className="leading-5 text-white">
