  ...
  return (
    <div className="w-[90%] mx-auto my-8 bg-poise bg-cover bg-no-repeat bg-[rgba(5,255,255,0.7)]">
      <div className="w-full p-10 bg-[rgba(23,14,14,0.95)]">
        ...
        <div className="flex gap-2 justify-center font-semibold text-button mb-3">
          <span>Charisma.</span>
          <span>Class.</span>
          <span>Comfort.</span>
        </div>
        <div className="text-start">
          <div className="lg:basis-[20%] mb-4">
            <h5 className="font-bold text-button mb-2">Vision</h5>
          ...
          <div className="lg:basis-[20%] mb-4">
            <h5 className="font-bold text-button mb-2">Why Us?</h5>
            <p className="leading-5 text-white font-light">
          ...
          <div className="lg:basis-[20%] mb-4">
            <h5 className="font-bold text-button mb-2">100% Quality</h5>
            <p className="leading-5 text-white font-light">
